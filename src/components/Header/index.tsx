      ...
      <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2 md:px-5 2xl:px-10">
        ...
        <div className="hidden xl:block">
          <div>
            ...
            <p className="font-medium">We are, MangueSpace 2.0, our goal is to facilitate the access to valuable earth data, which can help on decisions and calculations to the people who play a vital role in the economic chain, the farmers.</p>
          </div>
        </div>
